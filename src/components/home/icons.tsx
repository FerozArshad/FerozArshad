...
import type { SkillIcon } from "@/data/home/skills";
import type { ServiceIcon } from "@/data/home/services";

const iconMap: Record<SkillIcon | ServiceIcon, LucideIcon> = {
  globe: Globe,
  search: Search,
  terminal: Terminal,
  package: Package,
...
/* Official brand marks (simple-icons paths), fill: currentColor */
...
export function FiverrIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M16.25 16.25v-10h-10v-.625c0-1.036.84-1.875 1.875-1.875H10V0H8.125A5.632 5.632 0 0 0 2.5 5.625v.625H0V10h2.5v6.25H0V20h8.75v-3.75h-2.5V10h6.25v6.25h-2.5V20h8.75v-3.75h-2.5zM20.625 5a1.875 1.875 0 1 0 0-3.75 1.875 1.875 0 0 0 0 3.75z" />
    </svg>
  );
}
