...
export default async function AdminDashboard() {
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl font-extrabold text-foreground tracking-tight mb-2">Welcome Back, Feroz.</h1>
            <p className="text-muted-foreground mb-10 text-lg">Here is the current status of your portfolio architecture.</p>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {stats.map((stat, idx) => (
                    <div key={idx} className="p-6 rounded-2xl bg-card border border-border flex items-center gap-6 shadow-sm">
            ...
            <div className="p-8 rounded-2xl bg-card border border-border shadow-sm">
                ...
                <p className="text-muted-foreground mb-6">Manage your core data models directly connected to your Hostinger MariaDB server.</p>

                <div className="grid md:grid-cols-3 gap-6">
                    <button className="w-full py-4 bg-muted hover:bg-accent text-foreground rounded-xl transition font-medium border border-border text-sm tracking-wide">
