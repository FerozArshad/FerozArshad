                            ...
                            {insights.length === 0 ? (
                                <tr>
                                    <td colSpan={4} className="p-10 text-center text-muted-foreground">
                                        ...
                                        <p className="text-lg font-medium text-foreground mb-1">No insights published</p>
                                    ...
                                    <tr key={insight.id} className="hover:bg-muted/10 transition-colors group">
                                        ...
                                        <td className="p-6 align-middle hidden md:table-cell">
                                            {insight.publishedAt ? (
                                                ...
                                                <span className="px-2 py-1 rounded-md bg-muted text-muted-foreground text-xs font-semibold">Draft</span>
                                            )}
                                        </td>
